...
// Badges read as small tags, not pills (UI_CODING_STANDARDS.md §5.1 — Sharp
// radius, --r-pill:4px specifically). success/warning are a distinct hue
// family from --accent/default on purpose — a status pill must never be
// visually confusable with a primary action (§5.1's note on semantic colors).
