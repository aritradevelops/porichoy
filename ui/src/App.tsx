...
//
// No auth gating yet — there's no lib/client to check a real session against
// (UI_CODING_STANDARDS.md §13), so "/" renders the shell directly rather than
// redirecting through a login check that doesn't exist.
export function App() {
  return (
    <ThemeProvider>
