...
var configureCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		rootApp.LandingUrl = rootApp.Domain + "/"
		rootApp.RedirectUris = []string{rootApp.Domain + "/authorize"}
		rootApp.SuccessCallbackUrl = rootApp.Domain + "/authorize"
		rootApp.ErrorCallbackUrl = rootApp.Domain + "/authorize/error"
